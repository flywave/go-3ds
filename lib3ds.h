...
extern LIB3DSAPI void lib3ds_matrix_copy_to_double(double dest[4][4], float src[4][4]);
...
extern LIB3DSAPI void lib3ds_matrix_mult_double(double m[4][4], double a[4][4], double b[4][4]);
...
extern LIB3DSAPI int lib3ds_matrix_inv_double(double m[4][4]);
extern LIB3DSAPI void lib3ds_matrix_translate(float m[4][4], float x, float y, float z);
extern LIB3DSAPI void lib3ds_matrix_translate_to_double(double m[4][4], float x, float y, float z);  
